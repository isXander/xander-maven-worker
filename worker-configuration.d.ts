/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a766e924689baf25d86e362e0433c051)
// Runtime types generated with workerd@1.20260410.1 2026-06-05 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MetadataDebouncer";
	}
	interface Env {
		releases: R2Bucket;
		snapshots: R2Bucket;
		...
		SERVER_NAME: "Xander's Maven Server";
		REPOSITORIES: "releases,snapshots";
		CHECKSUM_VALIDATION: "true";
		CHECKSUM_AUTOGENERATION: "true";
		ALLOW_OVERWRITES: "false";
		VALIDATE_PATHS: "true";
		PEPPER: string;
		METADATA_DEBOUNCER: DurableObjectNamespace<import("./src/index").MetadataDebouncer>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SERVER_NAME" | "REPOSITORIES" | "CHECKSUM_VALIDATION" | "CHECKSUM_AUTOGENERATION" | "ALLOW_OVERWRITES" | "VALIDATE_PATHS" | "PEPPER">> {}
}
...
interface CacheContext {
    purge(param1: CachePurgeOptions): Promise<CachePurgeResult>;
}
...
interface Tracing {
    ...
    Span: typeof user_tracingSpan;
}
declare abstract class user_tracingSpan {
    get isTraced(): boolean;
    setAttribute(param1: string, param2?: (boolean | number | string)): void;
}
